...
from dbgpt.core.awel.operators.common_operator import JoinOperator, MapOperator
...
with DAG("simple_nl_schema_sql_chart_example") as dag:
    ...
    llm = MoonshotLLMClient(api_key=os.getenv("MOONSHOT_API_KEY", "sk-hcDfcKdnS9hpvXiYXqP9RQZQQTq68JKhuoyW2oqBitO3bEjO"))
